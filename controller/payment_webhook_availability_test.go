...
func TestAlipayTopUpEnabledRequiresComplianceOfficialSourceAndConfig(t *testing.T) {
	...
	setting.AlipayPaymentSource = "epay"
	require.False(t, isAlipayTopUpEnabled())
