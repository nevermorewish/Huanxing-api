...
import (
	...
	"github.com/huanxing/huanxing-api/relay/channel/ai360"
	"github.com/huanxing/huanxing-api/relay/channel/lingyiwanwu"

	//"github.com/huanxing/huanxing-api/relay/channel/minimax"
	"github.com/huanxing/huanxing-api/relay/channel/openrouter"
	"github.com/huanxing/huanxing-api/relay/channel/xinference"
	...
	"github.com/huanxing/huanxing-api/setting/reasoning"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		if header.Get("HTTP-Referer") == "" {
			header.Set("HTTP-Referer", "https://docs.huanxing.com")
		}
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "huanxing")
		}
	}
	return nil
}
