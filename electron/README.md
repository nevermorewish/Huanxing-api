# huanxing Electron Desktop App

This directory contains the Electron wrapper for huanxing, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., huanxing-api-macos)
cp ../huanxing-api-macos ../huanxing-api
```
...
- Store database in `../data/huanxing-api.db`
...
### Database Location
- **Development**: `../data/huanxing-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/huanxing/data/`
  - Windows: `%APPDATA%/huanxing/data/`
  - Linux: `~/.config/huanxing/data/`
