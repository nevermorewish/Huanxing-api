...
import (
	...
	perfmetrics "github.com/huanxing/huanxing-api/pkg/perf_metrics"
	"github.com/huanxing/huanxing-api/relay"
	"github.com/huanxing/huanxing-api/router"
	"github.com/huanxing/huanxing-api/service"
	_ "github.com/huanxing/huanxing-api/setting/performance_setting"
...
func main() {
	...
	common.SysLog("huanxing " + common.Version + " started")
	...
	go controller.AutomaticallyRunChannelTypeMonitors()
...
func InjectUmamiAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Umami huanxing-->\n")
...
func InjectGoogleAnalytics() {
	...
	analyticsInjectBuilder.WriteString("<!--Google Analytics huanxing-->\n")
	analyticsInject := []byte(analyticsInjectBuilder.String())
